            ...
            <div class="filter-section">
                <form method="GET" action="index.php" id="filterForm" class="filter-form" autocomplete="off">
                    ...
                    <select name="type" class="form-select filter-select" onchange="this.form.submit()">
                        ...
                        <option value="main_hub" <?php if ($type === 'main_hub')
                            echo 'selected'; ?>>Hub Chính</option>
                        <option value="station" <?php if ($type === 'station')
                            echo 'selected'; ?>>Trạm vệ tinh</option>
                    </select>

                    <select name="manager_id" class="form-select filter-select" onchange="this.form.submit()">
                        <option value="">-- Quản lý --</option>
                        <?php foreach ($managers as $m): ?>
                            <option value="<?php echo $m['id']; ?>" <?php if ($manager_id == $m['id'])
                                   echo 'selected'; ?>>
                    ...
                    <select name="status" class="form-select filter-select" onchange="this.form.submit()">
                        ...
                        <option value="1" <?php if ($status === '1')
                            echo 'selected'; ?>>Đang hoạt động</option>
                        <option value="0" <?php if ($status === '0')
                            echo 'selected'; ?>>Tạm ngưng</option>
                    </select>
                        ...
                        <?php if (!empty($hubs)):
                            foreach ($hubs as $hub): ?>
                                <tr>
                                    ...
                                    <td><?php echo htmlspecialchars($hub['type'] == 'main_hub' ? 'Hub Chính' : 'Trạm vệ tinh'); ?>
                                    </td>
                            ...
                            <?php endforeach; else: ?>
                            <tr>
                                <td colspan="10" align="center" style="padding: 30px;">Chưa có dữ liệu kho bãi.</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
