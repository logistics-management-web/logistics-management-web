...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (!check_permission('trucks', 'edit')) {
        echo "<script>alert('Lỗi bảo mật: Bạn chỉ có quyền xem danh sách xe và tài xế!'); window.location.href='index.php';</script>";
        exit;
    }
                    ...
                    <?php if (!empty($drivers)):
                        foreach ($drivers as $dr): ?>
                            <tr>
                                ...
                                <td>
                                    <span
                                        class="status-badge <?php echo ($dr['work_status'] == 'active') ? 'status-green' : 'status-red'; ?>">
                                        <?php echo ($dr['work_status'] == 'active') ? '● Đang hoạt động' : '● Ngoại tuyến'; ?>
                                    </span>
                                </td>
                                <td>
                                    <?php if (check_permission('trucks', 'edit')): ?>
                                        <button class="btn-icon text-blue" data-bs-toggle="modal" data-bs-target="#editDriverModal"
                                        ...
                                        <form method="POST" style="display:inline-block;">
                                            ...
                                            <button type="submit" name="submit_toggle_status"
                                                class="btn-icon <?php echo ($dr['work_status'] == 'active') ? 'text-gray' : 'text-bold text-blue'; ?>"
                                        ...
                                        <form method="POST" style="display:inline-block;">
                                            ...
                                            <button type="submit" name="submit_delete_driver" class="btn-icon"
                                                style="color: #ef4444;"
                        ...
                        <?php endforeach; else: ?>
                        <tr>
                            <td colspan="6" class="text-center text-gray">Chưa có dữ liệu tài xế.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form method="POST">
                    ...
                    <div class="modal-footer" style="border-top: none;">
                        <button type="submit" name="submit_edit_driver" class="btn btn-primary w-100">Cập nhật thay
                            đổi</button>
                    </div>
                </form>
            </div>
