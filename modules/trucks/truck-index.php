            ...
            <table>
                ...
                <tbody>
                    <?php if (!empty($trucks)):
                            ...
                            <tr>
                                <td class="clearfix">
                                    ...
                                    <div class="info-container">
                                        <div class="text-bold text-blue"><?php echo htmlspecialchars($tr['plate_number']); ?>
                                        </div>
                                        <div class="text-gray" style="font-size: 12px;">
                                            <?php echo htmlspecialchars($tr['brand_model']); ?></div>
                                    </div>
                                </td>
                                <td><span class="text-bold"><?php echo htmlspecialchars($tr['truck_type']); ?></span></td>
                                <td><?php echo number_format($tr['capacity_kg']); ?> kg</td>
                                <td><?php echo $tr['driver_name'] ? htmlspecialchars($tr['driver_name']) : '<span class="text-gray">Chưa phân công</span>'; ?>
                                </td>
                                <td>
                                    <span
                                        class="status-badge <?php echo ($tr['status'] == 'active') ? 'status-green' : 'status-red'; ?>">
                        ...
                        <?php endforeach; else: ?>
                        <tr>
                            <td colspan="6" class="text-center text-gray">Không có dữ liệu xe tải.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <form class="modal-content" method="POST">
                ...
                <div class="modal-body">
                    <div class="row mb-3">
                        <div class="col-md-6"><label class="form-label text-gray">Biển số xe</label><input type="text"
                                class="form-control" name="plate_number" placeholder="VD: 29C-123.45" required></div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6"><label class="form-label text-gray">Tải trọng (kg)</label><input
                                type="number" class="form-control" name="capacity_kg" required></div>
                        <div class="col-md-6"><label class="form-label text-gray">Hãng & Model</label><input type="text"
                                class="form-control" name="brand_model" placeholder="VD: Hino 500" required></div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6"><label class="form-label text-gray">Loại giấy tờ</label><input type="text"
                                class="form-control" name="document_type" placeholder="VD: Đăng kiểm" required></div>
                        <div class="col-md-6"><label class="form-label text-gray">Số giấy tờ</label><input type="text"
                                class="form-control" name="document_number" required></div>
                    </div>
                    <div class="row">
                        <div class="col-md-6"><label class="form-label text-gray">Ngày cấp</label><input type="date"
                                class="form-control" name="issue_date" required></div>
                        <div class="col-md-6"><label class="form-label text-gray">Ngày hết hạn</label><input type="date"
                                class="form-control" name="expiry_date" required></div>
                    </div>
                </div>
                <div class="modal-footer" style="border-top: none;">
                    <button type="submit" name="submit_add_truck" class="btn btn-primary w-100">Lưu thông tin xe
                        tải</button>
                </div>
            </form>
        </div>
    ...
    <div class="modal fade" id="editTruckModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <form class="modal-content" method="POST">
                ...
                <div class="modal-body">
                    <div class="row mb-3">
                        <div class="col-md-6"><label class="form-label text-gray">Biển số</label><input type="text"
                                class="form-control" name="plate_number" id="edit_plate_number" required></div>
                        <div class="col-md-6"><label class="form-label text-gray">Loại xe</label><select
                                class="form-select" name="truck_type" id="edit_truck_type">
                                <option value="Xe máy">Xe máy</option>
                                <option value="Tải Van">Tải Van</option>
                                <option value="Tải thùng kín">Tải thùng kín</option>
                            </select></div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6"><label class="form-label text-gray">Tải trọng (kg)</label><input
                                type="number" class="form-control" name="capacity_kg" id="edit_capacity_kg" required>
                        </div>
                        <div class="col-md-6"><label class="form-label text-gray">Tài xế</label><select
                                class="form-select" name="main_driver_id"
                                id="edit_main_driver_id"><?php foreach ($drivers as $d): ?>
                                    <option value="<?php echo $d['id']; ?>"><?php echo $d['full_name']; ?></option>
                                <?php endforeach; ?>
                            </select></div>
                    </div>
                    <div class="mb-3"><label class="form-label text-gray">Hãng & Model</label><input type="text"
                            class="form-control" name="brand_model" id="edit_brand_model" required></div>
                    <h6 class="text-blue border-bottom pb-2 mb-3 mt-4 text-bold">Giấy tờ xe</h6>
                    <div class="row mb-3">
                        <div class="col-md-6"><label class="form-label text-gray">Loại giấy tờ</label><input type="text"
                                class="form-control" name="document_type" id="edit_document_type" required></div>
                        <div class="col-md-6"><label class="form-label text-gray">Số giấy tờ</label><input type="text"
                                class="form-control" name="document_number" id="edit_document_number" required></div>
                    </div>
                    <div class="row">
                        <div class="col-md-6"><label class="form-label text-gray">Ngày cấp</label><input type="date"
                                class="form-control" name="issue_date" id="edit_issue_date" required></div>
                        <div class="col-md-6"><label class="form-label text-gray">Ngày hết hạn</label><input type="date"
                                class="form-control" name="expiry_date" id="edit_expiry_date" required></div>
                    </div>
                </div>
                <div class="modal-footer" style="border-top: none;">
                    <button type="submit" name="submit_edit_truck" class="btn btn-primary w-100">Cập nhật thay
                        đổi</button>
                </div>
            </form>
        </div>
    ...
    <div class="modal fade" id="viewDocumentModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-bold">Giấy tờ xe: <span class="text-blue" id="doc_plate_title"></span>
                    </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body">
